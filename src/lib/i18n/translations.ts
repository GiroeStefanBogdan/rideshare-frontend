export const translations = {
	en: {
		...
		account: {
			...
			smokingAllowedHint: 'I am okay with smoking passengers in my ride',
			petFriendly: 'Allow Pets',
			petFriendlyHint: 'I am okay with passengers bringing pets in my ride',
		...
		reviews: {
			count: 'reviews',
			none: 'No reviews yet',
			noneYet: 'No reviews yet. Members you travelled with can review you.',
			toWrite: 'Reviews to write',
			nothingToWrite:
				'Nothing to review right now. After a ride ends, your travel companions appear here.',
			write: 'Write review',
			update: 'Update review',
			writeTitle: 'Write a review',
			updateTitle: 'Update your review',
			reviewingDriver: 'You travelled as a passenger',
			reviewingPassenger: 'You travelled as a driver',
			writtenAsDriver: 'Written as a driver',
			writtenAsPassenger: 'Written as a passenger',
			scoreLabel: 'Score',
			scoreRequired: 'Choose a score from 1 to 5.',
			commentLabel: 'Comment (optional)',
			commentPlaceholder: 'How was the ride?',
			save: 'Save review',
			cancel: 'Cancel',
			submitFailed: 'Could not save the review.',
			saved: 'Your review has been recorded',
			pendingEditor: 'Your pending update',
			awaitingOther: 'Waiting for the other member',
			edited: 'Edited',
			hide: 'Hide',
			restore: 'Restore',
			failedModerate: 'Could not update the review.'
		},
		userProfile: {
			back: 'Back',
			bio: 'Bio',
	...
	ro: {
		...
		reviews: {
			count: 'recenzii',
			none: 'Nicio recenzie încă',
			noneYet: 'Nicio recenzie încă. Membrii cu care ai călătorit te pot recenza.',
			toWrite: 'Recenzii de scris',
			nothingToWrite:
				'Momentan nu ai ce recenza. După ce o cursă se încheie, colegii de călătorie apar aici.',
			write: 'Scrie recenzie',
			update: 'Actualizează recenzia',
			writeTitle: 'Scrie o recenzie',
			updateTitle: 'Actualizează recenzia',
			reviewingDriver: 'Ai călătorit ca pasager',
			reviewingPassenger: 'Ai călătorit ca șofer',
			writtenAsDriver: 'Scrisă ca șofer',
			writtenAsPassenger: 'Scrisă ca pasager',
			scoreLabel: 'Notă',
			scoreRequired: 'Alege o notă de la 1 la 5.',
			commentLabel: 'Comentariu (opțional)',
			commentPlaceholder: 'Cum a fost cursa?',
			save: 'Salvează recenzia',
			cancel: 'Renunță',
			submitFailed: 'Recenzia nu a putut fi salvată.',
			saved: 'Recenzia ta a fost înregistrată',
			pendingEditor: 'Actualizarea ta în așteptare',
			awaitingOther: 'Se așteaptă celălalt membru',
			edited: 'Editată',
			hide: 'Ascunde',
			restore: 'Restabilește',
			failedModerate: 'Recenzia nu a putut fi actualizată.'
		},
		userProfile: {
			back: 'Înapoi',
			bio: 'Biografie',
